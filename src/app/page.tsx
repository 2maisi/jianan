...
import JaHeader from "./components/header/header";
import JiaBanner from "./components/banner";
        ...
        <div className="flex flex-row w-full">
          ...
          <div className="ml-5 w-full flex flex-col">
            <div className="flex flex-row items-center">
              <div className="w-6 h-6 font-bold text-xs flex items-center p-2 border justify-center text-red-600 border-red-600 rounded-md mr-2">营</div>
            ...
            <div className="flex-1">
              ...
              <div className="text-black text-sm">门店1家 | 设计团队9人 | 施工队5支 | 经营面积300平米</div>

              <div className="text-sm mt-2 mb-2 text-gray-600">公司地址</div>
              <div className="text-black text-sm">东方路1381号22楼AB座</div>
            </div>
            <div className="flex flex-row items-center">
              <Button className="flex-1" color="default" style={{color: "black", borderColor: "black", height: "50px"}} icon={
                <div>
                  <LocalPhoneIcon style={{width:"19px"}}/>
                </div>
              }>{mobile}</Button>
              <div className="w-4"></div>
              <Button className="flex-1" variant="solid" color="primary" style={{height: "50px"}}>立即预约</Button>
            </div>
          </div>
